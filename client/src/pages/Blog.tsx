...
const blogPosts: BlogPost[] = [
  ...
  /* ── MIGRATED FROM OLD RAMPRATE.COM ── */
  {
    title: "It's Time to Uber and Airbnb the Telecommunications Industry",
    url: "https://ramprate.com/its-time-to-uber-and-airbnb-the-telecommunications-industry/",
    excerpt: "Uber and Airbnb transformed their industries by decentralizing old systems — and now it's telecom's turn. Verizon, AT&T, and the legacy carriers are ripe for disruption by platforms that unlock stranded capacity.",
    tags: ["Telecom", "Disruption", "Infrastructure"],
    verdict: "prescient" as Verdict,
    verdictNote: "5G marketplace models and network-as-a-service platforms now validate this thesis.",
    importance: 4 as const,
  },
  {
    title: "Hiding Fees in the Transparent Age Is Just Bad Business",
    url: "https://ramprate.com/hiding-fees-in-the-transparent-age-is-just-bad-business/",
    excerpt: "In an era where every contract term can be benchmarked and every hidden fee exposed, opacity is a liability. The companies that win are the ones that price honestly.",
    tags: ["Sourcing", "Transparency", "Enterprise"],
    verdict: "proved-true" as Verdict,
    verdictNote: "FTC crackdowns on junk fees and enterprise procurement transparency tools proved this thesis correct.",
    importance: 3 as const,
  },
  {
    title: "PERI Finance Announces IEO on Gate.io",
    url: "https://ramprate.com/peri-finance-announces-ieo-on-gate-io/",
    excerpt: "PERI Finance launches its IEO on Gate.io for decentralized derivatives trading, bringing synthetic assets and cross-chain DeFi to a broader audience.",
    tags: ["Web3", "DeFi", "Tokens"],
    verdict: "emerging" as Verdict,
    verdictNote: "Decentralized derivatives grew into a multi-billion dollar market. Cross-chain synthetics remain an active frontier.",
    importance: 2 as const,
  },
  {
    title: "Your Words Are Hammers",
    url: "https://ramprate.com/your-words-are-hammers/",
    excerpt: "Speaking as a tool for getting things done. The words you choose in negotiations, pitches, and leadership moments are not decoration — they are instruments of force.",
    tags: ["Leadership", "Communication", "Strategy"],
    verdict: "evergreen" as Verdict,
    verdictNote: "Timeless framework for executive communication and high-stakes negotiation.",
    importance: 3 as const,
  },
  {
    title: "Executives from Tech Giants Join Syntropy to Scale Global Adoption",
    url: "https://ramprate.com/executives-from-tech-giants-join-syntropy-to-scale-global-adoption/",
    excerpt: "Shawn Hakl (former SVP at Verizon) and Roman Pacewicz bring deep experience in B2B innovation, sales, and product management to Syntropy's mission of building the new internet.",
    tags: ["Web3", "Infrastructure", "Growth"],
    verdict: "proved-true" as Verdict,
    verdictNote: "Syntropy's enterprise traction validated the thesis that Web3 infrastructure needs traditional enterprise talent to scale.",
    importance: 3 as const,
  },
  {
    title: "New Internet: The Real-World Pied Piper of the 'New Internet'",
    url: "https://ramprate.com/new-internet-the-real-world-pied-piper-of-the-new-internet/",
    excerpt: "Syntropy is building a fundamentally better internet — faster, more secure, and decentralized. This is the real-world version of Silicon Valley's Pied Piper, and it's already working.",
    tags: ["Web3", "Infrastructure", "Decentralization"],
    verdict: "prescient" as Verdict,
    verdictNote: "Decentralized networking protocols gained major traction. The 'new internet' thesis is now mainstream venture capital consensus.",
    importance: 4 as const,
  },
  {
    title: "So Now That We Admit We Have a Problem — Part 2",
    url: "https://ramprate.com/so-now-that-we-admit-we-have-a-problem-part-2/",
    excerpt: "How do we avoid making things worse with IT solutions? After admitting the procurement problem exists, the next step is building systems that don't compound the dysfunction.",
    tags: ["Sourcing", "IT", "Enterprise"],
    verdict: "evergreen" as Verdict,
    verdictNote: "The IT procurement dysfunction cycle described here remains the #1 reason enterprises overspend.",
    importance: 3 as const,
  },
  {
    title: "Optimize & Re-Negotiate Contracts",
    url: "https://ramprate.com/optimize-re-negotiate-contracts/",
    excerpt: "100% job satisfaction in IT is rare — each day brings new headaches. But contract optimization is the single highest-ROI activity a CIO can undertake, and most aren't doing it.",
    tags: ["Sourcing", "Contracts", "Enterprise"],
    verdict: "evergreen" as Verdict,
    verdictNote: "Contract renegotiation remains the fastest path to IT budget recovery. This playbook still works.",
    importance: 3 as const,
  },
  {
    title: "Scale & Buy Global IT Infrastructure",
    url: "https://ramprate.com/scale-buy-global-it-infrastructure/",
    excerpt: "Owning a big IT budget is like sudden fame — everyone wants to be your friend. The key is knowing who's actually on your side when you're scaling globally.",
    tags: ["Infrastructure", "Sourcing", "Global"],
    verdict: "evergreen" as Verdict,
    verdictNote: "Global infrastructure procurement complexity has only increased. This framework remains essential.",
    importance: 3 as const,
  },
  {
    title: "Mini Episode: Tony Greenberg, CEO of RampRate",
    url: "https://ramprate.com/mini-episode-tony-greenberg-ceo-of-ramprate/",
    excerpt: "How to think when $100M's are on the line. Tony Greenberg shares the decision frameworks that guide the world's largest IT sourcing engagements.",
    tags: ["Leadership", "Sourcing", "Strategy"],
    verdict: "evergreen" as Verdict,
    verdictNote: "The decision frameworks outlined here have been applied to $24B+ in enterprise transactions.",
    importance: 3 as const,
  },
  {
    title: "'Boiling the Human' — H+ Summit Transcript / Harvard-Kurzweil",
    url: "https://ramprate.com/boiling-the-human-h-summit-transcript-harvard-kurzweil/",
    excerpt: "Excerpts from a presentation at the H+ Conference at Harvard University. Building a services market where compute meets the human operating system.",
    tags: ["AI", "Futurism", "Human Potential"],
    verdict: "prescient" as Verdict,
    verdictNote: "Presented at Harvard in 2010, this human-compute convergence thesis predated the AI revolution by over a decade.",
    importance: 4 as const,
  },
  {
    title: "Hot Sauce, Is What I Got — Sourcing, Is What I Got",
    url: "https://ramprate.com/hot-sauce-is-what-i-got-just-remember-that-sourcing-is-what-i-got/",
    excerpt: "A holiday reflection on what makes RampRate different: sourcing isn't just procurement, it's a craft built on relationships, data, and relentless execution.",
    tags: ["Sourcing", "Culture", "Enterprise"],
    verdict: "evergreen" as Verdict,
    verdictNote: "The sourcing-as-craft philosophy continues to define RampRate's approach to enterprise advisory.",
    importance: 2 as const,
  },
  {
    title: "The Right Numbers: Supplier Fit, Gross National Happiness, and Blockchain",
    url: "https://ramprate.com/the-right-numbers-supplier-fit-gross-national-happiness-and-blockchain/",
    excerpt: "The world is in the midst of a statistical revolution. Everything can be measured with more precision than ever — but are we measuring the right things? Supplier fit, happiness indices, and blockchain converge.",
    tags: ["Data", "Blockchain", "Impact"],
    verdict: "prescient" as Verdict,
    verdictNote: "ESG metrics, supplier scoring, and on-chain analytics all validated this convergence thesis.",
    importance: 4 as const,
  },
];
